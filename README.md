...
**Audio Formats:** MP3, M4A, WAV, FLAC, AC-3, E-AC-3, DTS
...
|-------|--------|----------|
| 📝 Requirements & Design | 🟡 In Progress | Week 1-2 |
| 🔧 Environment Setup | ⏳ Pending | Week 2 |
| 🎨 Core UI Development | ⏳ Pending | Week 3-6 |
| ⚙️ FFmpeg Integration | ⏳ Pending | Week 7-8 |
...
- **[FFmpeg](https://ffmpeg.org/)** - Powerful media processing engine
- **[PyQt6](https://www.riverbankcomputing.com/software/pyqt/)** - Excellent GUI framework
